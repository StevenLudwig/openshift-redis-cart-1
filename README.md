...
If you install this cartridge from source, you will be using a precompiled version of Redis 3.2.2 for RHEL6.  You can run the <code>bin/control update</code> script on each gear to build and update to the latest version of the Redis 3.2.2 tree.
